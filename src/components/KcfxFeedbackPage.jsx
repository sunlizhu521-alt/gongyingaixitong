...
const FEEDBACK_CONFIG = {
  receipt: {
    ...
    columns: [
      ...
      { key: 'operationStatus', label: '销售/运营状态', render: (row) => row.rowData?.operationStatus || '' },
      { key: 'inventoryCause', label: '库存形成原因', render: (row) => row.rowData?.inventoryCause || '' },
      { key: 'consumptionPlan', label: '初步消耗方案', render: (row) => row.rowData?.consumptionPlan || '' },
