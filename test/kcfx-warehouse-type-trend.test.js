...
test('sales outbound warehouse location trend includes every location and fills missing months', () => {
  const result = buildSalesOutboundWarehouseLocationTrend([
    { month: '2026-01', warehouseLocation: '国内', qty: 10, amount: 100 },
    { month: '2026-01', warehouseLocation: '欧洲', qty: 20, amount: 200 },
    { month: '2026-02', warehouseLocation: '国内', qty: 15, amount: 150 },
    { month: '2026-02', warehouseLocation: '北美', qty: 30, amount: 300 }
  ], 'qty', ['2026-01', '2026-02']);

  assert.deepEqual(result.months, ['2026-01', '2026-02']);
  assert.deepEqual(result.series.map((item) => item.warehouseType), ['北美', '国内', '欧洲']);
