...
test('销售汇总保留全部交易并按三个独立条件分类筛选', () => {
  ...
  records['sales-data'] = record([
    ...
    { 日期: '2026-01-02', 客户名称: '拼多多*迈德斯特官方旗舰店', 物料编码: '1002', 客户物料编码: '客户A1002', 仓库: '集成仓', 应收数量: 2, '销售额-不含税': 20 },
    { 日期: '2026-01-03', 客户名称: '杭州国源养老科技有限公司', 物料编码: '1003', 客户物料编码: '客户A1003', 仓库: '销售仓', 应收数量: 3, '销售额-不含税': 30 },
